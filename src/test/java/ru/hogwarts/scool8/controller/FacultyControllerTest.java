...
class FacultyControllerTest {
    ...
    public void saveFacultyTest() throws Exception {
        final String name = "Факультет Х";
        final String color = "Розовый";
        final long id = 1;
        ...
        when(facultyRepository.findFacultyByColorContainsIgnoreCase(eq(color))).thenReturn(Collections.singleton(faculty));
